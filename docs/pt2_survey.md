...
読むだけなので `--depth 1` の shallow clone でよい。
...
git clone --depth 1 --recurse-submodules https://github.com/NVIDIA-RTX/RTXDI.git
...
| `refs/Screen-Space-ReSTIR-GI/` | `Rendering/ReSTIRGI/`(抽出版、最初に読む) | pt2.1 |
| `refs/kajiya/` | `docs/gi-overview.md`、`assets/shaders/rtdgi/restir_*.hlsl`、`assets/shaders/ircache/` | pt2.1 / 2.2 |
| `refs/RTXDI/` | `Doc/RestirGI.md`, `Doc/ShaderAPI-RestirGI.md`、`Libraries/Rtxdi/Include/Rtxdi/GI/*.hlsli`(submodule) | pt2.1 |
