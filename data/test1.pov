...
#declare _bgcolor = <0.000000,0.000000,0.000000>;

#ifndef (_transpbg)
background {color rgb _bgcolor}
#else
// transparent background
background {color rgbt <0.000000,0.000000,0.000000,0.999>}
#declare _no_fog = 1;
#end
...
#ifndef (_no_fog)
fog {
  distance 50.000000/3
  color rgbf <0.000000,0.000000,0.000000,0>
  fog_type 2
  fog_offset 0
  fog_alt 1.0e-10
  up <0,0,1>
...
#declare _scene = #include "test1.inc"
